...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        img_ItemBarFrame[0].sprite = sprite_ItemBarSlotOn;
    ...
    public void ItemBar_SelectRightSlot() {
        ...
        img_ItemBarFrame[itemBar_nowSelectSlot].sprite = sprite_ItemBarSlotOff;

        itemBar_nowSelectSlot = itemBar_Clamp(itemBar_nowSelectSlot + 1);

        //셀렉할 슬롯의 sprite를 셀렉중임을 표시하는 sprite로 바꾼다.
        img_ItemBarFrame[itemBar_nowSelectSlot].sprite = sprite_ItemBarSlotOn;
    }
    ...
    int itemBar_Clamp(int value) {
        int min = 0;
        int max= img_ItemBarFrame.Length-1;
