...
public class MapGenerator : MonoBehaviour
{
    ...
    void CreateBlock(Vector3 blockpos, bool visual) {
        if (blockpos.y > 22 + groundHeightOffset)//눈블럭
        {
            if (visual)
            {
                GameObject blockObj = (GameObject)Instantiate(blockPrefabs[(int)Block.Type.Snow], blockpos, Quaternion.identity);
        ...
        else if (blockpos.y > 15 + groundHeightOffset)//잔디블럭
        {
            if (visual)
            {
                GameObject blockObj = (GameObject)Instantiate(blockPrefabs[(int)Block.Type.Grass], blockpos, Quaternion.identity);
        ...
        else if (blockpos.y > 0 + groundHeightOffset)
        {
            if (visual)//흙블럭
            {
                GameObject blockObj = (GameObject)Instantiate(blockPrefabs[(int)Block.Type.Dirt], blockpos, Quaternion.identity);
        ...
        if (blockpos.y > 0 && blockpos.y < 7 && Random.Range(0, 100) < 3)
        {
            if (visual)
            {
                GameObject blockObj = (GameObject)Instantiate(blockPrefabs[(int)Block.Type.Gold], blockpos, Quaternion.identity);
        ...
        if (blockpos.y == 0)//기반암 생성
        {
            if (visual)
            {
                GameObject blockObj = (GameObject)Instantiate(blockPrefabs[(int)Block.Type.Diamond], blockpos, Quaternion.identity);
